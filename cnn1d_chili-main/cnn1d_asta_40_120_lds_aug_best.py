...
def data_1D(f):
    ...
    x_test['ASTA'] = Y_val
    x_test.to_csv('test_chili_asta.csv')
...
def run():
    ...
    file_name = '/home/amc012/Desktop/chili-specx/chili-001.csv'
    ...
    for e in range(n_epoch):
        ...
        with torch.no_grad():
            ...
            if v_loss<best_v_loss:
                best_v_loss = v_loss
                model_path = 'model_asta_40_120_lds_dataaug_5_{}_{}'.format(timestamp,e+1)
    ...
    y_data.to_csv('chili_val_lds_aug_actual_pred_5.csv')

    xx_data = pd.DataFrame()
    xx_data['actual'] = b_yt_dt
    xx_data['predcted'] = b_xhat
    xx_data.to_csv('chili_train_lds_aug_actual_pred_5.csv')
